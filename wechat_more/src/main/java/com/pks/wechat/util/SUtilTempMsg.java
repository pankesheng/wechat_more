...
public class SUtilTempMsg {
	 ...
	 * @return
	 */
	public static boolean sendPayMentNoticeMsg(String appId,String openid,String url,String title,String orderNo,String goodName,String goodCount,String money,String remark){
		...
		JSONObject jsonObject = sendTempMsg(appId,new Gson().toJson(tm));
		if (jsonObject!=null) {
	 ...
	 * @return
	 */
	public static boolean sendBuySuccessNoticeMsg(String appId,String openid,String url,String title,String product,String price,String time,String remark){
		Map<String, TempData> data = new HashMap<String, TempData>();
		data.put("first", new TempData(title));
	 ...
	 * @return
	 */
	public static boolean sendPayMentSuccessNoticeMsg(String appId,String openid,String url,String title,String orderNo,String time,String money,String paytype,String remark){
		Map<String, TempData> data = new HashMap<String, TempData>();
		data.put("first", new TempData(title));
		data.put("keyword1", new TempData(orderNo));
	...
	public static JSONObject sendTempMsg(String appId,String json){
		AccessToken accessToken = SUtilBase.getAccessToken(appId);
		String requestUrl = WeChatUrlConfiguration.TEMP_SEND_URL.replace("ACCESS_TOKEN", accessToken.getAccess_token());
		JSONObject jsonObject = SUtilCommon.httpsRequest(requestUrl, "POST", json);
		return jsonObject;
	}
