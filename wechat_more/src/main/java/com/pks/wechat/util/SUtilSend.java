...
public class SUtilSend {
	...
	public static String makeArticleTagMessage(Boolean is_to_all,Integer tag_id,String media_id,Integer send_ignore_reprint) {
		...
		String jsonMsg = "{\"filter\":{\"is_to_all\":%s,\"tag_id\":%s},\"mpnews\":{\"media_id\":\"%s\"},\"msgtype\":\"mpnews\",\"send_ignore_reprint\":%s}";
		jsonMsg = String.format(jsonMsg,is_to_all,tag_id,media_id,send_ignore_reprint);
		return jsonMsg;
	}
